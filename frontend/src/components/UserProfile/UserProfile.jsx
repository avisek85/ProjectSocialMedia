...
function UserProfile() {
  ...
  // console.log("params._id is before function ",params.id);
    ...
    <div className="account">
      ...
      <div className="accountright">
       {user && (
        ...
        {myProfile ? null : <Button variant="contained" onClick={followHandler} disabled={followLoading} style={{background:following?"red":""}}>{following?"Unfollow":"Follow"}</Button>}
